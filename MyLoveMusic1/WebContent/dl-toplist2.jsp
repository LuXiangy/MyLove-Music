...
<div class="body1">
	...
	<div class="mynav">
    	<ul class="nav" id="nv">
            ...
            <li><a href="dl-toplist.jsp"  class="n_tj"  onClick="change_bg(this)"><em>排行榜</em></a></li>
   		...
   		<div class="top">
            ...
            <ul class="top_1">
                ...
                <li class="left_1">
               		 <div class="div2"></div> 
                        <p class="p1">
                            <a href="dl-toplist2.jsp">MyLove音乐新歌榜</a> 
                        </p>
                     <p class="p2">每天更新</p>
                </li>
                <li class="left_3">
                	 <div class="div3"></div> 
                        <p class="p1">
                            <a href="dl-toplist3.jsp">MyLove音乐原创歌曲榜</a> 
                        </p>
                     <p class="p2">每周四更新</p>
                </li>
                <li class="left_4">
    ...
    <div class="content_right">
   		<div class="g-wrap">
       		<div class="cnt">
                ...
                <div class="m-info">
               		<div class="f-cb">
                   		 <h2 class="f-ff2" id="f-ff2">MyLove音乐新歌榜</h2>
                    </div> 
                    <div class="user">
                   		<i class="u-icn"></i>
...
：终于补了不能说的秘密，没有现在青春片的车祸，留学，堕胎，奢华。小清新，剧情也不落俗套。最重要的的是配乐太好听了！！！ 
   ...
   <!--  <a id="toTop" title="回到顶部" href="" hidefocus="true"  style="display:none;">回到顶部</a> -->
    <script src="js/dl-toplist2.js"></script>
