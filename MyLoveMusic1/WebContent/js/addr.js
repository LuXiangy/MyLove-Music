var pro=document.getElementById("store_add_info_province");
var city=document.getElementById("store_add_info_city");
var area=document.getElementById("store_add_info_area");
...
xmlhttp.open("GET","../../js/city.xml",true); //异步
xmlhttp.send(null);
